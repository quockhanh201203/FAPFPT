                ...
                <ul class="pagination text-center" style="margin-left: 6%;">
                    ...
                    <c:choose>
                        <c:when test="${sessionScope.page.getTotal() <= sessionScope.page.getPageLimit()}">
                            <li class="page-item active"><a class="page-link" href="admin?cp=${sessionScope.page.getCurrentPage()}${keySearch}" onclick="handlePageClick(event)">${sessionScope.page.getCurrentPage()}</a></li>
                            </c:when>
                            <c:otherwise>
                                <c:if test="${sessionScope.page.getCurrentPage()>1&&sessionScope.page.getCurrentPage()<sessionScope.page.getTotalPage()}">
                                <li class="page-item"><a class="page-link" href="admin?cp=1${keySearch}" onclick="handlePageClick(event)">First</a></li>
                                <li class="page-item"><a class="page-link" href="admin?cp=${sessionScope.page.getCurrentPage()-1}${keySearch}" onclick="handlePageClick(event)">${sessionScope.page.getCurrentPage()-1}</a></li>
                                <li class="page-item active"><a class="page-link" href="admin?cp=${sessionScope.page.getCurrentPage()}${keySearch}" onclick="handlePageClick(event)">${sessionScope.page.getCurrentPage()}</a></li>
                                <li class="page-item"><a class="page-link" href="admin?cp=${sessionScope.page.getCurrentPage()+1}${keySearch}" onclick="handlePageClick(event)">${sessionScope.page.getCurrentPage()+1}</a></li>
                                <li class="page-item"><a class="page-link" href="admin?cp=${sessionScope.page.getTotalPage()}${keySearch}">Last</a></li>
                                </c:if>
                                ...
                                <li class="page-item"><a class="page-link" href="admin?cp=1${keySearch}">First</a></li>
                                <li class="page-item"><a class="page-link" href="admin?cp=${sessionScope.page.getCurrentPage()-1}${keySearch}" onclick="handlePageClick(event)">${sessionScope.page.getCurrentPage()-1}</a></li>
                                <li class="page-item active"><a class="page-link" href="admin?cp=${sessionScope.page.getCurrentPage()}${keySearch}" onclick="handlePageClick(event)">${sessionScope.page.getCurrentPage()}</a></li>
                                </c:if>
                            </c:otherwise>
